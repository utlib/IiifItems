...
?>
<a href="<?php echo isset($_SERVER['HTTP_REFERER']) ? $_SERVER['HTTP_REFERER'] : admin_url(array('controller' => $type, 'id' => $thing->id, 'action' => 'show'), 'id'); ?>" class="green button">Return to Previous Page</a>
